...
- [4. Real-time Data Processing with Flink](#4-real-time-data-processing-with-flink)
  ...
  - [4.3. Flink DataStream API](#43-flink-datastream-api)
    ...
    - [4.3.4. Generate the Output Stream](#434-generate-the-output-stream)
    - [4.3.5. Sink the Output Stream](#435-sink-the-output-stream)
...
### 4.3.3. Stream Transformation and Aggregation
